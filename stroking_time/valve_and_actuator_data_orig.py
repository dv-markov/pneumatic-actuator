...
d_pipe_1 = 4 / 1000  # m, internal channels in
le_pipe_1 = 100 / 1000  # m
d_pipe_2 = 8 / 1000  # m, supply pressure pipe
le_pipe_2 = 3  # m
d_pipe_3 = 5 / 1000  # m , internal channels out
...
# act_model = "AT501U D / SC ..."  # @ 4 bar(g)
# torque_da = 454  # N*m, @ P_in
# torque_spring_start = 0  # N*m
# torque_spring_end = 0  # N*m
# total_volume = 3.14 / 1000  # m3
# act_weight = 21.4  # kg
